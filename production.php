...
<body><noscript><strong>We're sorry but vue-cryptopro-pdf-sign doesn't work properly without JavaScript enabled. Please
  ...
  <script src=<?=$f?>/js/vue-cryptoPro-pdf-sign/dist/js/chunk-vendors.js> </script> <script
    src=<?=$f?>/js/vue-cryptoPro-pdf-sign/dist/js/app.js> </script> </body> </html>
